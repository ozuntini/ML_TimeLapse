...
cp /Users/olivierzuntini/Documents/Projects/MagicLantern/ML_TimeLapse/$nameScript /Volumes/EOS_DIGITA1/ML/scripts/
...
if [ "$recupLog" == "1" ]; then
    ...
    ./mount.sh
    echo "-> Recup du .LOG"
    cp /Volumes/EOS_DIGITAL/*.LOG /Users/olivierzuntini/Documents/Projects/MagicLantern/ML_TimeLapse/tmp/SD0/
    echo "-> Recup du .LOG"
    cp /Volumes/EOS_DIGITA1/*.LOG /Users/olivierzuntini/Documents/Projects/MagicLantern/ML_TimeLapse/tmp/SD1/
    echo "-> Fermeture des cartes 1 et 2"
    hdiutil detach "/Volumes/EOS_DIGITAL"
    hdiutil detach "/Volumes/EOS_DIGITA1"
fi
